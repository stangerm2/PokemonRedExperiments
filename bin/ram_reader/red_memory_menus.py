...
TEXT_MENU_CURSOR_LOCATIONS = {
    (0xd3, 0xc3): "Start Menu pokedex",
    (0xfB, 0xc3): "Start Menu pokemon",
    (0x23, 0xc4): "Start Menu item",
    (0x4b, 0xc4): "Start Menu self",
    (0x73, 0xc4): "Start Menu save",
    (0x9b, 0xc4): "Start Menu option",
    (0xc3, 0xc4): "Start Menu quit",

    (0x4C, 0xC4): "Pokecenter heal",
    (0x74, 0xC4): "Pokecenter cancel",

    (0xB5, 0xC3): "Pokemart buy",
    (0xDD, 0xC3): "Pokemart sell",
    (0x05, 0xC4): "Pokemart quit",

    (0xC9, 0xC3): "PC someone",
    (0xC9, 0xC3): "PC someone withdraw",
    (0xF1, 0xC3): "PC someone deposit",
    (0x19, 0xC4): "PC someone release",
    (0x41, 0xC4): "PC someone change box",
    (0x69, 0xC4): "PC someone exit",
    (0xF1, 0xC3): "PC self",
    (0xC9, 0xC3): "PC self withdraw item",
    (0xF1, 0xC3): "PC self deposit item",
    (0x19, 0xC3): "PC self toss item",
    (0x41, 0xC4): "PC self exit",
    (0x19, 0xC4): "PC oak",
    (0x41, 0xC4): "PC logoff",

    (0xC1, 0xC4): "Battle/wild menu, fight",
    (0xA9, 0xC4): "Battle/wild mv1",
    (0xBD, 0xC4): "Battle/wild mv2",
    (0xD1, 0xC4): "Battle/wild mv3",
    (0xE5, 0xC4): "Battle/wild mv4",
    (0xC7, 0xC4): "Battle menu, pkmn",
    (0xB4, 0xC3): "Battle/roster pkmn 1",
    (0xDC, 0xC3): "Battle/roster pkmn 2",
    (0x04, 0xC4): "Battle/roster pkmn 3",
    (0x2C, 0xC4): "Battle/roster pkmn 4",
    (0x54, 0xC4): "Battle/roster pkmn 5",
    (0x7C, 0xC4): "Battle/roster pkmn 6",
    (0xE9, 0xC4): "Battle menu, item",
    (0x8A, 0xC4): "Battle menu, item X - use",
    (0xB2, 0xC4): "Battle menu, item X - toss",
    (0xF5, 0xC3): "Battle item 1",
    (0x1D, 0xC4): "Battle item 2",
    (0x45, 0xC4): "Battle item #",
    (0xEF, 0xC4): "Battle menu, run",

    (0x4F, 0xC4): "Wild catch name yes",
    (0x77, 0xC4): "Wild catch name no"
}
...
# CC30: 4B  CC31: C4 - start menu self
...
# CC30: B4  CC31: C3 - Battle + StartMenu pkmn 1
# CC30: DC  CC31: C3 - Battle + StartMenu pkmn 2
# CC30: 04  CC31: C4 - Battle + StartMenu pkmn 3
# CC30: 2C  CC31: C4 - Battle + StartMenu pkmn 4
# CC30: 54  CC31: C4 - Battle + StartMenu pkmn 5
# CC30: 7C  CC31: C4 - Battle + StartMenu pkmn 6
